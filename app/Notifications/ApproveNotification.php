...
class ApproveNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            Kami dengan senang hati menginformasikan bahwa pendaftaran anak anda telah berhasil dan diterima')
            ->line('Anda juga dapat memonitoring semua aktivitas di halaman dashboard.')
