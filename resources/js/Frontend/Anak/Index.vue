            ...
            <div class="block rounded">
                ...
                <div class="block-content p-0">
                    <el-table :data="data" class="w-100" v-loading="isLoading" header-cell-class-name="bg-body text-dark">
                        ...
                        <el-table-column prop="username" label="Nama Panggilan"/>
                        ...
                        <el-table-column label="Aksi" align="center" width="180">
                            <template #default="scope">
                                <a :href="route('user.anak.show', { id :scope.row.id})" class="ep-button ep-button--primary">
...
export default {
    ...
    methods :{
        ...
        async fetchData(page) {
            ...
            try {
                this.isLoading = true;
                const response = await axios.get(this.route("user.anak.data"),{
                    params: {
                        page : page,
