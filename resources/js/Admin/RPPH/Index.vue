    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                <span>RPPH</span>
                <div class="space-x-1">
                    <a :href="route('admin.rpph.create')" class="ep-button ep-button--primary">
            ...
            <div class="block rounded">
                    ...
                    <div class="block-content p-0">
                        <el-table :data="data" class="w-100" v-loading="isLoading" header-cell-class-name="bg-body text-dark">
                            ...
                            <el-table-column prop="tgl" label="Topik / Subtopik" width="200" header-align="center">
                                <template #default="scope">
                                    <div>{{ scope.row.topik }} / {{ scope.row.subtopik }}</div>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column prop="kelompok.admin.nama" label="Guru"/>
                            <el-table-column label="Aksi" align="center" width="180">
                                <template #default="scope">
                                    <a :href="route('admin.rpph.show', { id :scope.row.id})" class="ep-button ep-button--primary">
...
export default {
    ...
    methods :{
        ...
        async fetchData(page) {
            ...
            try {
                this.isLoading = true;
                const response = await axios.get(this.route("admin.rpph.data"),{
                    params: {
                        page : page,
