    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                <span>Laundry</span>
                <div class="space-x-1">
                    <a :href="route('admin.laundry.create')" class="ep-button ep-button--primary">
            ...
            <div class="block rounded">
                    ...
                    <div class="block-content p-0">
                        <el-table :data="data" class="w-100" header-cell-class-name="bg-body text-dark">
                            ...
                            <el-table-column label="Total Berat" width="220" header-align="center">
                                <template #default="scope">
                                    <div>{{ scope.row.total / 1000 }} Kg</div>
                                </template>
                            </el-table-column>
                            <el-table-column label="Aksi" align="center" width="180">
                                <template #default="scope">
                                    <a :href="route('admin.laundry.show', { id :scope.row.id})" class="ep-button ep-button--primary">
...
export default {
    ...
    methods :{
        ...
        async fetchData(page) {
            ...
            try {
                this.isLoading = true;
                const response = await axios.get(this.route("admin.laundry.data"),{
                    params: {
                        page : page,
