    ...
    <base-layout>
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content p-0">
                    <el-table :data="data" class="table-click" style="width: 100%" v-loading="isLoading" @sort-change="sortChange">
                        ...
                        <el-table-column prop="jenis.nama" label="Jenis" sortable/>
                        <el-table-column prop="tipe" label="Tipe" sortable/>
                        <el-table-column prop="indikator" label="Indikator" sortable/>
        ...
        <el-dialog v-model="showForm" :title="formTitle" width="40%" :before-close="onCloseForm" v-loading="loadingForm">
            <el-form :model="form" label-position="top">
                ...
                <el-form-item label="Jenis Kegiatan" :error="errors.admin_id">
                    <select-jenis-kegiatan v-model="form.jenis_id"/>
                </el-form-item>
                <el-form-item label="Tipe" :error="errors.tipe">
                    <el-select v-model="form.tipe" placeholder="Pilih" class="w-100">
                        <el-option label="Perkembangan" value="Perkembangan"/>
                        <el-option label="Pertumbuhan" value="Pertumbuhan"/>
                        <el-option label="Pembiasaan" value="Pembiasaan"/>
                    </el-select>
                </el-form-item>
...
export default {
    ...
    methods :{
        ...
        submit() {
            ...
            let url = this.editMode == true ? this.route('admin.kegiatan.update', {id : this.form.id}) : this.route('admin.kegiatan.store');
            form.post(url, {
                preserveScroll: true,
                onFinish:() => {
        ...
        hapus(id){
            ...
            .then(() => {
                this.$inertia.delete(this.route('admin.kegiatan.delete', {id : id}), {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.fetchData();
                        ElMessage({
