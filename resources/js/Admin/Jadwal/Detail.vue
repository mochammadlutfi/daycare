    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                <span>Jadwal Kelompok {{ jadwal.kelompok.nama }}</span>
                <div class="space-x-1">
...
export default {
    ...
    methods :{
        ...
        async fetchData(page) {
            ...
            try {
                this.isLoading = true;
                const response = await axios.get(this.route("admin.jadwal.detail.data", {id : this.jadwal.id}),{
                    params: {
        ...
        submit() {
            ...
            let url = this.editMode == true ? 
            this.route('admin.jadwal.detail.update', {id :this.jadwal.id, detail : this.form.id}) 
            : this.route('admin.jadwal.detail.store', { id :this.jadwal.id });
            form.post(url, {
                preserveScroll: true,
                onFinish:() => {
        ...
        hapus(id){
            ...
            .then(() => {
                this.$inertia.delete(this.route('admin.jadwal.detail.delete', {id : this.jadwal.id, detail : id}), {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.fetchData();
                        ElMessage({
