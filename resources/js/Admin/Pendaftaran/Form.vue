    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                <span>Form Pendaftaran Baru</span>
                <div class="space-x-1">
                ...
                <el-form label-position="top" :model="form" ref="form" :rules="rules">
                    <div class="block-content" v-if="step == 1">
                        <div class="border-bottom border-2 mb-4">
                            ...
                            <el-row :gutter="20">
                                <el-col :md="12">
                                    <div class="form-check form-block mb-4">
                                        <input class="form-check-input" type="radio" v-model="form.has_account" name="has_account" value="0" id="akun-sudah">
                                        <label class="form-check-label" for="akun-sudah">
                                ...
                                <el-col :md="12">
                                    <div class="form-check form-block mb-4">
                                        <input class="form-check-input" type="radio" v-model="form.has_account" name="has_account" value="1" id="akun-belum">
                                        <label class="form-check-label" for="akun-belum">
                                            <span class="d-flex align-items-center">
                                            <span class="ms-2">
                            ...
                            <el-row :gutter="20" v-if="form.has_account == 0">
                                <el-col :md="12">
                                    <el-form-item label="Nama Akun" :error="errors.nama_akun" prop="nama_akun">
                                        <el-input v-model="form.nama_akun" />
                                    </el-form-item>
                                    <el-form-item label="Email Akun" :error="errors.email_akun" prop="email_akun">
                                        <el-input v-model="form.email_akun" />
                                    </el-form-item>
                                </el-col>
                                <el-col :md="12">
                                    <el-form-item label="Password" :error="errors.password_akun" prop="password_akun">
                                        <el-input type="password" v-model="form.password_akun" show-password/>
                                    </el-form-item>
                                    <el-form-item label="Konfirmasi Password" :error="errors.password_confirmation_akun" prop="password_confirmation_akun">
                                        <el-input type="password" v-model="form.password_confirmation_akun" show-password/>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-row :gutter="20" v-else>
                                <el-col :md="12">
                                    <el-form-item label="Pengguna" :error="errors.akun_id" prop="akun_id">
                                        <el-input v-model="form.akun_id" />
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </div>
                    ...
                    <div class="block-content" v-else-if="step == 2">
                        ...
                        <el-row :gutter="10">
                            ...
                            <el-col :md="8">
                        <el-form-item label="Scan KTP Ayah" :error="errors.ktp_ibu" prop="ktp_ibu">
                    ...
                    <div class="block-content" v-else-if="step == 4">
                    ...
                    <div class="block-content p-4">
                        <div class="d-flex justify-content-end">
                            ...
                            <el-button native-type="submit" type="primary" @click.prevent="updateStep()" v-if="step <= 4">
                                <i class="fa fa-chevron-right me-2"></i>
                                Selanjutnya
                            </el-button>
                            <el-button native-type="submit" type="primary" @click.prevent="submit()" v-if="step == 5">
...
export default {
    ...
    data(){
        return {
            form : {
                ...
                email_akun : null,
                password_akun : null,
                password_confirmation_akun : null,
                nama_ayah : null,
                tmp_lahir_ayah : null,
                tgl_lahir_ayah : null,
                alamat_ayah : null,
    ...
    computed :{
        rules(){
            if(this.step == 1){
                if(this.form.has_account == 0){
                    return {
                        nama_akun : [
                            { required: true, message: 'Nama Akun tidak boleh kosong' },
                        ],
                        email_akun : [
                            { required: true, message: 'Email Akun tidak boleh kosong' },
                        ],
                        password_akun : [
                            { required: true, message: 'Password Akun tidak boleh kosong' },
                        ],
                        password_confirmation_akun : [
                            { required: true, message: 'Konfirmasi Password Akun tidak boleh kosong' },
                    ...
                    return {
                        akun_id : [
                            { required: true, message: 'Data Akun tidak boleh kosong' },
                        ],
                    }
                }
            }else if(this.step == 2){
    ...
    methods : {
        ...
        validateConfirmPassword(rule, value, callback) {
            if (value === '') {
                callback(new Error('Konfirmasi Password harus diisi'));
            } else if (value !== this.form.password_akun) {
