    ...
    <base-layout>
        <div class="content">
            <div class="content-heading d-flex justify-content-between align-items-center">
                ...
                <div class="space-x-1">
                    <a :href="route('admin.antarjemput.create')" class="ep-button ep-button--primary">
            ...
            <div class="block rounded">
                    ...
                    <div class="block-content p-0">
                        <el-table :data="data" class="w-100" v-loading="isLoading" header-cell-class-name="bg-body text-dark">
                            ...
                            <el-table-column prop="jam" label="Jam" header-align="center">
                                <template #default="scope">
                                    <div>{{ format_jam(scope.row.jam) }}</div>
                                </template>
                            </el-table-column>
                            <el-table-column prop="admin.nama" label="Penjemput"/>
                            ...
                            <el-table-column label="Aksi" align="center" width="180">
                                <template #default="scope">
                                    <a :href="route('admin.antarjemput.show', { id :scope.row.id})" class="ep-button ep-button--primary">
...
export default {
    ...
    methods :{
        ...
        async fetchData(page) {
            ...
            try {
                this.isLoading = true;
                const response = await axios.get(this.route("admin.antarjemput.data"),{
                    params: {
                        page : page,
